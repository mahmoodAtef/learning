...
{
  OnGoingDataModel ({required String ? courseId, required int ? completed, required double? userRate}) :
...
static  OnGoingData fromJson (Map <String , dynamic> json ){
    ...
    return OnGoingData
      (courseId: json["cid"], completed: json["completed"] , userRate: json["rate"].toDouble());
  }
